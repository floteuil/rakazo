  ...
  return {
    plugins: [
      ...
      },
      {
        ...
        configureServer: (server) => attachNovncProxy(server, getScreenProxySecret()),
        configurePreviewServer: (server) => attachNovncProxy(server, getScreenProxySecret()),
      },
    ],
    server: {
      host: "127.0.0.1",
